...
WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/a_2'))

WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/button_Continue Shopping'))

WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/button_Add to cart_1_2'))

WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/button_Add to cart_1_2_3'))
