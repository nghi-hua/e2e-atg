...
WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/img_Remove_inventory_item_img'))
...
WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/button_Remove'))

WebUI.click(findTestObject('Object Repository/Input/Page_Swag Labs/button_Remove_1'))
